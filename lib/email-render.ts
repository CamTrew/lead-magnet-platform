...
export const MAGNETS_EMAIL_FOOTER_TEXT = 'Build yours free with Magnets: https://magnets.so/register?utm_source=email_footer&utm_medium=referral&utm_campaign=powered_by_magnets';
export const MAGNETS_EMAIL_FOOTER_HTML = '<table class="magnets-email-footer" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;background:#080d18;border-radius:0 0 12px 12px"><tr><td align="center" style="padding:30px 20px"><a href="https://magnets.so/register?utm_source=email_footer&amp;utm_medium=referral&amp;utm_campaign=powered_by_magnets" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:11px 16px;background:#ffffff;border:1px solid #d6d3d1;border-radius:6px;font:600 14px/20px Arial,sans-serif;color:#292524;text-decoration:none"><img src="https://magnets.so/brand/magnets-mark.png" alt="" width="22" height="22" style="display:inline-block;width:22px;height:22px;margin-right:8px;border:0;vertical-align:middle" /><span style="vertical-align:middle">Build yours free with Magnets</span></a></td></tr></table>';
