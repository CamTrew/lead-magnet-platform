...
async function run() {
  ...
  assert.match(String(ownedEmailRequest?.body?.html), /<h1[^>]*margin:24px 0 34px/);
  ...
  assert.match(String(ownedEmailRequest?.body?.html), /<h2[^>]*margin:22px 0 30px/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h3[^>]*>Heading 3<\/h3>/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h3[^>]*margin:20px 0 26px/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h4[^>]*>Heading 4<\/h4>/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h4[^>]*margin:18px 0 24px/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h5[^>]*>Heading 5<\/h5>/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h5[^>]*margin:17px 0 22px/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h6[^>]*>Heading 6<\/h6>/);
  assert.match(String(ownedEmailRequest?.body?.html), /<h6[^>]*margin:16px 0 20px/);
